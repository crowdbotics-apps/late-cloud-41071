"""
Django settings for late_cloud_41071 project.
...
ROOT_URLCONF = 'late_cloud_41071.urls'
...
WSGI_APPLICATION = 'late_cloud_41071.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_cloud_41071 API",
    "DESCRIPTION": "API documentation for late_cloud_41071 App",
    "VERSION": "v1",
}
